...
@section('container')
    <div class="mt-5 pt-5 d-flex justify-content-center align-items-center">
        <div class="card" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; width: 1200px; height: 600px">
            <div class="card-body d-flex justify-content-evenly py-4">
                <div id="profilBtn" class="col-md-4 text-center mt-3"
                    ...
                    <button class="ubahProfil btn btn-outline-success mb-2" data-bs-toggle="modal"
                        data-bs-target="#profil-{{ Auth::user()->id }}"><small>Ubah Profil</small>
                    </button>
                    <button class="ubahPw btn btn-outline-success mb-2" data-bs-toggle="modal"
                        data-bs-target="#ubahpw"><small>Ubah Password</small>
                    </button>
                    <button class="programKu btn btn-outline-success mb-2" onclick="location.href='/programku'"
                        type="button">
                        <small>Program Saya</small>
                    </button>
                    <button class="donasiKu btn btn-outline-success mb-2" onclick="location.href='/rwytdonasi'"
                        type="button">
                        <small>Riwayat Donasi</small>
                    </button>

                    <button class="donasiKu btn btn-outline-success mb-2" data-bs-toggle="modal" data-bs-target="#ajukan"
                        type="button">
